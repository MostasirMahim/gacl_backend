...
urlpatterns = [
    ...
    path("v1/restaurants/<int:pk>/detail/", views.RestaurantDetailView.as_view(),
    ...
    path("v1/restaurants/items/<int:pk>/detail/",
         views.RestaurantItemDetailView.as_view(),
         name="restaurant_item_detail_view"),
