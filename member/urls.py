...
urlpatterns = [
    ...
    path('v1/portal/invoices/<int:invoice_id>/', portal_views.MyInvoiceDetailView.as_view(),
    ...
    path('v1/portal/events/', portal_views.AvailableEventsView.as_view(),
         name="portal_events"),
    path('v1/portal/events/buy/', portal_views.PortalEventTicketBuyView.as_view(),
         name="portal_events_buy"),
